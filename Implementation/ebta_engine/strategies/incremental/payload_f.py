...
class PayloadFStrategy(PayloadEStrategy):
    ...
    def _signal(self, frame_m1: pd.DataFrame, frame_m3: pd.DataFrame) -> pd.Series:
        ...
        h1 = frame_from_bars(resample_ohlcv(self._bars_m1, 60))
        h4 = frame_from_bars(resample_ohlcv(self._bars_m1, 240))
        d1 = frame_from_bars(resample_ohlcv(self._bars_m1, 1440))
