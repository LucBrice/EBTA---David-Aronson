...
| Champ | Valeur |
| --- | --- |
| Parent | Baseline pre-implementation a enregistrer, sans appel `continue` direct. |
| Prochain enfant | `PLAN_TESTS_WRC_CALIBRATION_METAMORPHIQUE` |
| Action | Rediger un intake atomique, l'evaluer deux fois, le router, l'evaluer deux fois apres routage, puis seulement le baseliner et l'activer. |
