...
0 - HUMAN START HERE/archive/AUDIT_BUG_HUNTER_PLAN_APPROBATION_LIVE_DERIVEE_2026-08-09.md
0 - HUMAN START HERE/archive/AUDIT_ADVERSARIAL_PLAN_APPROBATION_LIVE_DERIVEE_2026-08-09.md
0 - HUMAN START HERE/archive/AUDIT_CONFORMITE_PLAN_APPROBATION_LIVE_DERIVEE_2026-08-09.md
```
...
- fournir dans chaque contraste bout en bout des preuves pre-OOS valides afin
  que le refus observe soit attribuable uniquement au chemin live/G13 ;
- inclure un controle positif `EXTERNAL`, pas seulement une fixture autorisee.
...
rg -n '"live_approval"\s*:\s*True|"live_approval"\s*:\s*true' Implementation/ebta_engine Implementation/examples/minimal_pilot_pipeline -g '*.py'
git diff --check
```
