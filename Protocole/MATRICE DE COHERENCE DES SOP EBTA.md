...
| --- | --- | --- | --- | --- | --- |
| 1. Definition de la candidate | SOP 03 | SOP 02, 03, 05, 06, 09A, 09B, 12 | Une candidate est une specification executable ayant produit une information exploitable ; si l'actif est selectionnable, le couple strategie x actif fait partie de l'identite ; toute variante influente appartient a la famille de recherche. | Definitions reprises dans plusieurs SOP avec des angles differents. Risque faible si SOP 03 est declaree proprietaire. | Dans le registre, attribuer a SOP 03 l'identite logique, le lineage, la deduplication, l'axe actif selectionnable et la famille ; SOP 06 ne possede que la selection locale. |
...
| 6. Univers des regles soumis aux tests multiples | SOP 02 avec source de verite SOP 03 | SOP 02, 03, 05, 06, 09A, 12 | WRC local sur l'univers complet et reconstructible ; candidates perdantes, actifs selectionnables, couples strategie x actif et variantes influentes conserves. | SOP 06 selectionne le maximum Test puis soumet la famille complete au WRC ; la phrase doit rester comprise comme selection mecanique, pas comme reduction de la famille ou des actifs perdants. | Dans le registre, distinguer `selected_candidate_id`, `candidate_family_tested` et `asset_universe`. |
...
| Axe actif selectionnable | SOP 03 + SOP 09A | Fixe par preregistration |
