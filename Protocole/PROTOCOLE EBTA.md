...
| P4 Scellement | Geler le paquet pré-OOS et obtenir `G-BIAS PASS` avant toute ouverture de `OOS_k`. | SOP 10, SOP 12, SOP 13 |
...
| P9 | Produire le paquet reproductible avec `G-BIAS PASS`, puis gouverner incubation, déploiement limité, monitoring et archivage. | SOP 11, SOP 12, SOP 13 |
...
8. Évaluer `G-BIAS` avant ouverture.
   Autorité : SOP 13.
9. Ouvrir OOS_k une seule fois.
   Autorité : SOP 10.
10. Exécuter passivement la candidate gelée.
   Autorité : SOP 08, SOP 09B, SOP 10.
11. Conserver le segment dans la chronologie globale.
...
| Gouvernance des biais et incidents | SOP 13 |
| Reproductibilité indépendante | SOP 12, SOP 13 |
| Incubation, déploiement limité et cycle de vie | SOP 11, SOP 12, SOP 13 |

Le gate économique ne remplace pas le gate statistique. La reproduction ne
répare pas une faiblesse méthodologique. Le gate transversal `G-BIAS` ne
remplace aucun gate statistique ; il peut toutefois bloquer l'ouverture OOS,
la validation reproductible, l'incubation ou le live si une décision est
contaminée par un biais humain, organisationnel ou assisté par IA. L’incubation
et le live ne sont autorisés qu’après les paquets et statuts exigés par SOP 11,
SOP 12 et SOP 13.
...
`G-BIAS` est un gate transversal gouverné par SOP 13. Il ne renumérote pas
`G0` à `G14`, mais il est obligatoire avant `G8 - Ouverture OOS`, avant
`G11 - Validation reproductible` et après tout incident de biais matériel. Un
`G-BIAS FAIL`, `INCONCLUSIVE` ou `BURNED` bloque le gate consommateur même si
les calculs statistiques ou économiques sont favorables.
...
| Gouvernance biais | Checklist `G-BIAS`, incidents, dérogations, revue du registre des risques. | SOP 13 |
...
- ignorer un incident de biais, une contamination IA, une communication influente ou une dérogation réparatrice ;
...
| SOP 13 - Gouvernance des biais humains et incidents méthodologiques | Incidents de biais, dérogations, contaminations IA, revue indépendante et gate transversal `G-BIAS`. |
